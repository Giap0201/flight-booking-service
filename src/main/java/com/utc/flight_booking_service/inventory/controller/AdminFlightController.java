...
import com.utc.flight_booking_service.inventory.service.FlightService;
...
public class AdminFlightController {
    ...
    @PatchMapping("/{id}")
    public ApiResponse<FlightUpdateResponseDTO> updateFlight(@PathVariable Long id, @RequestBody FlightUpdateRequestDTO request) {
    ...
    public ApiResponse<PriceUpdateResponseDTO> updatePrice(@PathVariable Long flightClassId,
